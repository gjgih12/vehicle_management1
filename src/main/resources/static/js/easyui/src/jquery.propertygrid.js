...
(function ($) {
    ...
    var groupview = $.extend({}, $.fn.datagrid.defaults.view, {
        ...
        renderGroup: function (target, groupIndex, group, frozen) {
            ...
            var table = [];
            table.push('<div class="datagrid-group" group-afterTree=' + groupIndex + '>');
            ...
            for (var j = 0; j < group.rows.length; j++) {
                ...
                table.push('<tr id="' + rowId + '" datagrid-row-afterTree="' + index + '" ' + cls + ' ' + style + '>');
        ...
        bindEvents: function (target) {
            ...
            body.unbind('click').bind('click', function (e) {
                ...
                if (expander.length) {
                    var gindex = expander.closest('div.datagrid-group').attr('group-afterTree');
    ...
    $.extend($.fn.datagrid.methods, {
        expandGroup: function (jq, groupIndex) {
            return jq.each(function () {
                ...
                var group = view.find(groupIndex != undefined ? 'div.datagrid-group[group-afterTree="' + groupIndex + '"]' : 'div.datagrid-group');
